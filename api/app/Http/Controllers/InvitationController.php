...
final class InvitationController
{
    ...
    /**
     * @response array{data: array{type: string, id: string, attributes: array{email: string, role: string, status: string, expiresAt: string, createdAt: string}, links: array{self: string}}, jsonapi: array{version: string}}
     */
    #[BodyParameter(
        name: 'data',
